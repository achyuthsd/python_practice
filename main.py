...
# Check whether a student passed or failed (pass mark = 40).
...
# Display grade based on marks (A, B, C, D, Fail).
...
# Check whether a salary is eligible for a bonus (e.g., salary ≥ 30000).
...
#     print('Yes its triangle')
# else:
#     print('No its not triangle')
